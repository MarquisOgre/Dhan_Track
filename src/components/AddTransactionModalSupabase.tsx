...
import { Category, Transaction, TransactionType, RecurrenceType, recurrenceOptions } from '@/hooks/useSupabaseTransactions';

type AddTransactionModalSupabaseProps = {
  categories: Category[];
  open: boolean;
...
export function AddTransactionModalSupabase({ categories, open, onOpenChange, onAdd }: AddTransactionModalSupabaseProps) {
